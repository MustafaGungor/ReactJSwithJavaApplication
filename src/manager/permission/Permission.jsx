...
import {Tabs,Tab,Label,Col,Panel,Button} from "react-bootstrap";
...
export default class Permission extends ShallowComponent{
        ...
        return(
            ...
            <Tabs defaultActiveKey={1} id="uncontrolled-tab-example">
                <Tab eventKey={1} title="Servis İzinleri">
                    ...
                    <Col md={2}>
                        <Button onClick={this.__saveData} bsStyle="info">Kaydet</Button>
                    </Col>
                    <Col md={12}>
    ...
    __saveDataMenu(e: Object, done: Function){
        ...
        this.AllSaveMenuPermissionRequest.call(selectDataMenu,undefined,this.__loginSuccess,this.__loginError,undefined);
    }
    ...
    __saveData(e: Object, done: Function){
        ...
        this.AllSavePermissionRequest.call(selectData,undefined,this.loginSuccess,this.__loginError,undefined);
